...
public class BoardController {
	...
	@RequestMapping(value= "/register",method = RequestMethod.POST)   // 입력하기 포스팅   입력 
	...
	public void listAll(Model model) throws Exception{
	 ...
	 @RequestMapping(value = "/readPage", method = RequestMethod.GET)   // 1개 글 읽기 메소드 글 읽으러 가자 
	 ...
	 @RequestMapping(value="/removePage",method= RequestMethod.POST)   // 삭제 메소드 
